...
public class CameraShake : MonoBehaviour
{
    ...
    {
        EventManager.StartListening(EventManager.Events.OnFire, ShakeCamera);
    }
    private void OnDisable()
    {
        EventManager.StopListening(EventManager.Events.OnFire, ShakeCamera);
    }
    ...
    public void ShakeCamera(Dictionary<string, object> obj)
    {
        Debug.Log("Shake on");
        canShake = true;
